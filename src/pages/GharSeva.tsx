...
<motion.span
  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full font-medium text-xl font-sans text-primary"
        ...
        <div className="w-full">
          ...
          <ScrollFadeIn>
            <motion.a
              ...
              whileHover={{ scale: 1.03, boxShadow: "0 20px 60px rgba(99,102,241,0.35)" }}
              whileTap={{ scale: 0.98 }}
