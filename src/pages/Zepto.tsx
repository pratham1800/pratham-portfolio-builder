      ...
      <section className="px-6 py-20" style={{ background: Z.lavender }}>
        <div className="max-w-6xl mx-auto">
          <ScrollFadeIn>
            ...
            <p className="mb-12 max-w-3xl leading-relaxed" style={{ color: Z.charcoalLight }}>28, IT Professional, high-heat urban hub. Orders during 4 PM – 9 PM window for chilled juices and carbonated drinks.
