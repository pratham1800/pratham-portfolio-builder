...
const Zepto = () => {
  ...
  return (
    <main className="pt-16">
      {/* Hero */}
      <section className="px-4 sm:px-6 py-16 sm:py-20 md:py-28" style={{ background: "linear-gradient(135deg, #111827 0%, #0a0f1a 100%)" }}>
        <div className="max-w-6xl mx-auto text-center">
          <ScrollFadeIn>
            <p className="text-sm tracking-widest uppercase mb-4" style={{ color: "#3B82F6" }}>Case Study</p>
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4" style={{ color: "#FFFFFF" }}>
              Beyond the Stopwatch
            </h1>
            <p className="text-base sm:text-lg md:text-xl mb-6 max-w-2xl mx-auto" style={{ color: "#D1D5DB" }}>
            ...
            <p className="text-sm max-w-2xl mx-auto leading-relaxed" style={{ color: "#9CA3AF" }}>
              Zepto's 10-minute delivery promise attracts users, but hidden product metadata and last-mile infrastructure failures drive them away.
            </p>
          </ScrollFadeIn>

          {/* About Zepto Card */}
          <ScrollFadeIn delay={0.2}>
            <motion.div whileHover={{ y: -4 }} className="mt-10 sm:mt-12 max-w-2xl mx-auto rounded-xl p-5 sm:p-6 text-left" style={{ background: "rgba(59,130,246,0.08)", border: "1px solid rgba(59,130,246,0.2)" }}>
              <h3 className="font-bold mb-2" style={{ color: "#3B82F6" }}>About Zepto</h3>
              <p className="text-sm mb-4" style={{ color: "#D1D5DB" }}>
                India's fastest growing quick commerce platform — delivering groceries in 10 minutes. Valued at $7B, operating 900+ dark stores across 70+ cities.
              </p>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollFadeIn>
            <div className="rounded-2xl p-6 sm:p-8 md:p-12" style={{ background: "#111827" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
                {[
                  ...
                  <div key={s.val} className="text-center">
                    <div className="font-mono-metric text-2xl sm:text-3xl md:text-4xl font-bold" style={{ color: s.color }}>{s.val}</div>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {frictionPoints.map((fp, i) => (
              <ScrollFadeIn key={fp.title} delay={i * 0.1}>
                <motion.div
                  ...
                  className="bg-card rounded-xl border border-border p-5 sm:p-6 md:p-8"
                >
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-3">
                        <span className="font-mono-metric text-xl sm:text-2xl font-bold" style={{ color: "#EF4444" }}>{fp.stat}</span>
          ...
          <ScrollFadeIn>
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, #111827 0%, #1e293b 100%)", border: "1px solid rgba(59,130,246,0.3)" }}
            >
              <p className="text-sm uppercase tracking-widest mb-4" style={{ color: "#3B82F6" }}>Key Insight</p>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold" style={{ color: "#FFFFFF" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {features.map((f, fi) => (
            <ScrollFadeIn key={f.num} delay={fi * 0.1}>
              <motion.div
                whileHover={{ y: -2 }}
                className="bg-card rounded-xl border border-border p-5 sm:p-6 md:p-8 mb-4 sm:mb-6"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                  {f.items.map(item => (
                    <motion.div
                      key={item.label}
                      whileHover={{ y: -2 }}
                      className="p-3 sm:p-4 rounded-lg bg-secondary"
                    >
          ...
          <div className="space-y-4 sm:space-y-6">
            {journeys.map((j, i) => (
              <ScrollFadeIn key={j.persona} delay={i * 0.1}>
                <motion.div whileHover={{ y: -2 }} className="rounded-xl border border-border bg-card overflow-hidden">
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollFadeIn>
            <motion.div
              whileHover={{ scale: 1.01 }}
              className="rounded-2xl p-6 sm:p-8 text-center mb-6 sm:mb-8"
              style={{ background: "linear-gradient(135deg, #111827 0%, #1e293b 100%)", border: "1px solid rgba(59,130,246,0.3)" }}
            >
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#3B82F6" }}>North Star Metric</p>
              <h3 className="text-xl sm:text-2xl font-bold mb-2" style={{ color: "#FFFFFF" }}>Customer Lifetime Value (LTV)</h3>
              <p className="font-mono-metric text-3xl sm:text-4xl font-bold mb-4" style={{ color: "#3B82F6" }}>+22%</p>
